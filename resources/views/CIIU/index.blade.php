...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body oncontextmenu="return false" >
		...
		<section class="container">
			<div class="row">
			   	<div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 mt-s col-xs-12">
				...
				<div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xs-12 ">
					<form route="limits" method="GET" class="form">
				    	
					    <div class="img-background">
					    	<img src="{{'img/icono_codigo_ciiu.png'}}" class="imgtamane">
					    </div>
						<h1 class="d-flex justify-content-center bg-size">CUÁNDO ME TOCA FACTURAR</h1>
			 			
				    		<div class="container">
				    			<div class="text-center">
				    						<div class="form-group">
				    						<input type="text" name="cel" class="form-control" id="actividadeconomica" aria-describedby="emailHelp" placeholder="Ingresa el Télefono" pattern="[0-9]{4}">
				    						</div>
				    						<div class="form-group">
				    						<input type="text" name="nit" class="form-control" id="actividadeconomica" aria-describedby="emailHelp" placeholder="Ingresa el NIT" pattern="[0-9]{4}">
				    						</div>
				    						<div class="form-group">
				    						<input type="text" name="name" class="form-control" id="actividadeconomica" aria-describedby="emailHelp" placeholder="Escribe tu nombre" pattern="[0-9]{4}">
				    						</div>
				    						<div class="form-group">
				    						<input type="email" name="email" class="form-control" id="actividadeconomica" aria-describedby="emailHelp" placeholder="Ingresa tu Email" pattern="[0-9]{4}">
				    						</div>
						...
						<div class="row">
							<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xs-12 mt-sl">
								<div id="info">
